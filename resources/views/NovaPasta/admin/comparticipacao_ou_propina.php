     ...
     <section class="content">
      <div class="container">
                           ...
                           <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <label>Id Matricula</label>
                                    <input type="text" class="form-control" placeholder="Nº Matricula" name="matricula">
            ...
            <div class="card">
             ...
             Todos os Pagamentos de Propinas

                    </h3>
                        <div class="card-tools">
                                <a href="?action=add-new" class="btn btn-success btn-sm"><i class="fa fa-plus mr-2"></i>Efectuar um novo pagamento</a>
