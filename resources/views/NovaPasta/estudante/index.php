...
<body >
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      <h3 class="logo"><img src="../../Projecto Final-cassela&dilson/assets/img/estrela.png">Estrela da Huila</a></h3>
        ...
        <div class="row" >
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="box">
              ...
              <ul>
               <img src="../assets/img/teacherr.png">
              </ul>
              <div class="btn-wrap">
                <a href="minha_mini_pauta.php" class="btn-buy">Minhas Notas</a>
              </div>
            </div>
          </div>
          ...
          <div class="row" >
            ...
            <div class="col-lg-4 col-md-6 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="300">
              <div class="box">
                ...
                <ul>
                  <img src="../img/turmass.png">
                 </ul>
                <div class="btn-wrap">
                  <a href="formulario_pedidos.php" class="btn-buy">Pedir um documeto</a>
                </div>
              </div>
            </div>
