          ...
          <div class="row" >
            <br>
              ...
              <div class="col-lg-2 col-6 text-center">
                    ...
                    <form action="/salvar_reclamacao_nota" method="POST">
                      ...
                      @csrf
                       ...
                       <div class="form-group">
                           ...
                           <input type="text" name="nome" placeholder="DIGITE O NOME O SEU NOME" required class="form-control">
                        </div> 
                      
                      
                        <div class="form-group">
                          <label for="duration">Curso </label>
                          <input type="text" name="curso" id="duration" class="form-control" placeholder="DIGITE O SEU CURSO" required>
                        </div>
                        <div class="form-group">
